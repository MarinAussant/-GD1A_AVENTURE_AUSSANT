...
export class SortieTemple extends Phaser.Scene{
    ...
    create(){
        ...
        if (this.playerState.unlockSortieTemple == false){
            const Cave_SortieTemple_HideLight = carteDuNiveau.createLayer("Cave_SortieTemple_HideLight",tileset);
        }
        ...
        if (this.playerState.unlockSortieTemple){
            const Cave_SortieTemple_Exit = carteDuNiveau.createLayer("Cave_SortieTemple_Exit",tileset);
        }
        else {
            const Cave_SortieTemple_LockExit = carteDuNiveau.createLayer("Cave_SortieTemple_LockExit",tileset);
            Cave_SortieTemple_LockExit.setCollisionByProperty({ collide: true });
            this.physics.add.collider(this.player, Cave_SortieTemple_LockExit);
        }
        ...
        this.physics.add.collider(this.player, Cave_SortieTemple_Collide);
